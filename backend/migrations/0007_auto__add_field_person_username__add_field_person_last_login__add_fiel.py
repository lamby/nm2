...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'person', 'username',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)

        # Adding field 'Person.last_login'
        db.add_column(u'person', 'last_login',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now),
                      keep_default=False)

        # Adding field 'Person.date_joined'
        db.add_column(u'person', 'date_joined',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now),
                      keep_default=False)

        # Adding field 'Person.is_staff'
        db.add_column(u'person', 'is_staff',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'person', 'username')

        # Deleting field 'Person.last_login'
        db.delete_column(u'person', 'last_login')

        # Deleting field 'Person.date_joined'
        db.delete_column(u'person', 'date_joined')

        # Deleting field 'Person.is_staff'
        db.delete_column(u'person', 'is_staff')
